...
00030128 <T_EXPECT0>:
   30128:	00 00 00 01 	add	r0,r1

0003012c <T_EXPECT1>:
   3012c:	80 00 00 00 	*unknown*

00030130 <T_EXPECT2>:
   30130:	00 00 00 02 	add	r0,r2

00030134 <T_EXPECT3>:
   30134:	80 00 00 01 	*unknown*

00030138 <T_EXPECT4>:
   30138:	80 00 00 01 	*unknown*

0003013c <T_EXPECT5>:
   3013c:	00 00 00 00 	add	r0,r0

00030140 <T_EXPECT6>:
   30140:	00 00 00 06 	add	r0,r6

00030144 <T_EXPECT7>:
   30144:	00 00 00 0e 	add	r0,r14

00030148 <T_EXPECT8>:
   30148:	00 00 00 1e 	add	r0,rbase

0003014c <T_EXPECT9>:
   3014c:	00 00 00 3e 	add	r1,rbase

00030150 <T_EXPECT10>:
   30150:	00 00 00 7e 	add	r3,rbase

00030154 <T_EXPECT11>:
   30154:	00 00 00 fe 	add	rtmp,rbase

00030158 <T_EXPECT12>:
   30158:	00 00 01 fe 	add	r15,rbase

0003015c <T_EXPECT13>:
   3015c:	00 00 03 fe 	add	rret,rbase

00030160 <T_EXPECT14>:
   30160:	00 00 07 fe 	*unknown*

00030164 <T_EXPECT15>:
   30164:	00 00 0f fe 	*unknown*

00030168 <T_EXPECT16>:
   30168:	00 00 1f fe 	*unknown*

0003016c <T_EXPECT17>:
   3016c:	00 00 3f fe 	*unknown*

00030170 <T_EXPECT18>:
   30170:	00 00 7f fe 	*unknown*

00030174 <T_EXPECT19>:
   30174:	00 00 ff fe 	*unknown*

00030178 <T_EXPECT20>:
   30178:	00 01 ff fe 	*unknown*

0003017c <T_EXPECT21>:
   3017c:	00 03 ff fe 	*unknown*

00030180 <T_EXPECT22>:
   30180:	00 07 ff fe 	*unknown*

00030184 <T_EXPECT23>:
   30184:	00 0f ff fe 	*unknown*

00030188 <T_EXPECT24>:
   30188:	00 1f ff fe 	*unknown*

0003018c <T_EXPECT25>:
   3018c:	00 3f ff fe 	*unknown*

00030190 <T_EXPECT26>:
   30190:	00 7f ff fe 	*unknown*

00030194 <T_EXPECT27>:
   30194:	00 ff ff fe 	*unknown*

00030198 <T_EXPECT28>:
   30198:	01 ff ff fe 	*unknown*

0003019c <T_EXPECT29>:
   3019c:	03 ff ff fe 	*unknown*

000301a0 <T_EXPECT30>:
   301a0:	07 ff ff fe 	*unknown*

000301a4 <T_EXPECT31>:
   301a4:	0f ff ff fe 	*unknown*

000301a8 <T_EXPECT32>:
   301a8:	1f ff ff fe 	*unknown*

000301ac <T_EXPECT33>:
   301ac:	3f ff ff fe 	*unknown*

000301b0 <T_EXPECT34>:
   301b0:	7f ff ff fe 	*unknown*

000301b4 <T_EXPECT35>:
   301b4:	ff ff ff fe 	*unknown*
...
00030214 <T_IMM_EXPECT0>:
   30214:	00 00 00 01 	add	r0,r1

00030218 <T_IMM_EXPECT1>:
   30218:	00 00 02 00 	add	r16,r0

0003021c <T_IMM_EXPECT2>:
   3021c:	ff ff fc 00 	*unknown*

00030220 <T_IMM_EXPECT3>:
   30220:	00 00 00 02 	add	r0,r2

00030224 <T_IMM_EXPECT4>:
   30224:	00 00 02 01 	add	r16,r1

00030228 <T_IMM_EXPECT5>:
   30228:	ff ff fc 01 	*unknown*

0003022c <T_IMM_EXPECT6>:
   3022c:	00 00 02 01 	add	r16,r1

00030230 <T_IMM_EXPECT7>:
   30230:	00 00 04 00 	*unknown*

00030234 <T_IMM_EXPECT8>:
   30234:	ff ff fe 00 	*unknown*

00030238 <T_IMM_EXPECT9>:
   30238:	00 00 04 01 	*unknown*

0003023c <T_IMM_EXPECT10>:
   3023c:	00 00 06 00 	*unknown*

00030240 <T_IMM_EXPECT11>:
   30240:	00 00 00 00 	add	r0,r0

00030244 <T_IMM_EXPECT12>:
   30244:	00 00 00 06 	add	r0,r6

00030248 <T_IMM_EXPECT13>:
   30248:	00 00 00 0e 	add	r0,r14

0003024c <T_IMM_EXPECT14>:
   3024c:	00 00 00 1e 	add	r0,rbase

00030250 <T_IMM_EXPECT15>:
   30250:	00 00 00 3e 	add	r1,rbase

00030254 <T_IMM_EXPECT16>:
   30254:	00 00 00 7e 	add	r3,rbase

00030258 <T_IMM_EXPECT17>:
   30258:	00 00 00 fe 	add	rtmp,rbase

0003025c <T_IMM_EXPECT18>:
   3025c:	00 00 01 fe 	add	r15,rbase

00030260 <T_IMM_EXPECT19>:
   30260:	00 00 03 fe 	add	rret,rbase

00030264 <T_IMM_EXPECT20>:
   30264:	00 00 07 fe 	*unknown*
