...
0000006c <check>:
 ...
 840:	01 50 41 00 	umull	r8,0x200
 ...
 868:	01 50 81 00 	umull	r8,0x400
 ...
 8b8:	01 50 41 00 	umull	r8,0x200
 ...
 8e0:	01 50 81 00 	umull	r8,0x400
 ...
 930:	01 50 41 00 	umull	r8,0x200
 ...
 958:	01 50 81 00 	umull	r8,0x400
 ...
 9a8:	01 50 41 00 	umull	r8,0x200
 ...
 9d0:	01 50 81 00 	umull	r8,0x400
 ...
 b10:	01 50 3d 1f 	umull	r8,0x1ff
 ...
 b38:	01 50 7d 1f 	umull	r8,0x3ff
 ...
 b60:	01 50 fd 1f 	umull	r8,0x7ff
...
00030130 <T_EXPECT2>:
   30130:	00 00 00 01 	add	r0,r1

00030134 <T_EXPECT3>:
   30134:	80 00 00 00 	*unknown*

00030138 <T_EXPECT4>:
   30138:	80 00 00 00 	*unknown*

0003013c <T_EXPECT5>:
   3013c:	00 00 00 00 	add	r0,r0

00030140 <T_EXPECT6>:
   30140:	00 00 00 09 	add	r0,r9

00030144 <T_EXPECT7>:
   30144:	00 00 00 31 	add	r1,r17

00030148 <T_EXPECT8>:
   30148:	00 00 00 e1 	add	rtmp,r1

0003014c <T_EXPECT9>:
   3014c:	00 00 03 c1 	add	rbase,r1

00030150 <T_EXPECT10>:
   30150:	00 00 0f 81 	*unknown*

00030154 <T_EXPECT11>:
   30154:	00 00 3f 01 	*unknown*

00030158 <T_EXPECT12>:
   30158:	00 00 fe 01 	*unknown*

0003015c <T_EXPECT13>:
   3015c:	00 03 fc 01 	*unknown*

00030160 <T_EXPECT14>:
   30160:	00 0f f8 01 	*unknown*

00030164 <T_EXPECT15>:
   30164:	00 3f f0 01 	*unknown*

00030168 <T_EXPECT16>:
   30168:	00 ff e0 01 	*unknown*

0003016c <T_EXPECT17>:
   3016c:	03 ff c0 01 	*unknown*

00030170 <T_EXPECT18>:
   30170:	0f ff 80 01 	*unknown*

00030174 <T_EXPECT19>:
   30174:	3f ff 00 01 	*unknown*

00030178 <T_EXPECT20>:
   30178:	ff fe 00 01 	*unknown*

0003017c <T_EXPECT21>:
   3017c:	ff fc 00 01 	*unknown*

00030180 <T_EXPECT22>:
   30180:	ff f8 00 01 	*unknown*

00030184 <T_EXPECT23>:
   30184:	ff f0 00 01 	*unknown*

00030188 <T_EXPECT24>:
   30188:	ff e0 00 01 	*unknown*

0003018c <T_EXPECT25>:
   3018c:	ff c0 00 01 	*unknown*

00030190 <T_EXPECT26>:
   30190:	ff 80 00 01 	*unknown*

00030194 <T_EXPECT27>:
   30194:	ff 00 00 01 	*unknown*

00030198 <T_EXPECT28>:
   30198:	fe 00 00 01 	*unknown*

0003019c <T_EXPECT29>:
   3019c:	fc 00 00 01 	*unknown*

000301a0 <T_EXPECT30>:
   301a0:	f8 00 00 01 	*unknown*

000301a4 <T_EXPECT31>:
   301a4:	f0 00 00 01 	*unknown*

000301a8 <T_EXPECT32>:
   301a8:	e0 00 00 01 	*unknown*

000301ac <T_EXPECT33>:
   301ac:	c0 00 00 01 	*unknown*

000301b0 <T_EXPECT34>:
   301b0:	80 00 00 01 	*unknown*

000301b4 <T_EXPECT35>:
   301b4:	00 00 00 01 	add	r0,r1

000301b8 <T_EXPECT36>:
   301b8:	00 00 00 01 	add	r0,r1
...
00030220 <T_IMM_EXPECT3>:
   30220:	00 00 00 01 	add	r0,r1

00030224 <T_IMM_EXPECT4>:
   30224:	00 00 02 00 	add	r16,r0

00030228 <T_IMM_EXPECT5>:
   30228:	00 00 04 00 	*unknown*

0003022c <T_IMM_EXPECT6>:
   3022c:	00 00 02 00 	add	r16,r0

00030230 <T_IMM_EXPECT7>:
   30230:	00 04 00 00 	*unknown*

00030234 <T_IMM_EXPECT8>:
   30234:	00 08 00 00 	*unknown*

00030238 <T_IMM_EXPECT9>:
   30238:	00 00 04 00 	*unknown*

0003023c <T_IMM_EXPECT10>:
   3023c:	00 08 00 00 	*unknown*

00030240 <T_IMM_EXPECT11>:
   30240:	00 10 00 00 	add	r0,0

00030244 <T_IMM_EXPECT12>:
   30244:	00 00 00 09 	add	r0,r9

00030248 <T_IMM_EXPECT13>:
   30248:	00 00 00 31 	add	r1,r17

0003024c <T_IMM_EXPECT14>:
   3024c:	00 00 00 e1 	add	rtmp,r1

00030250 <T_IMM_EXPECT15>:
   30250:	00 00 03 c1 	add	rbase,r1

00030254 <T_IMM_EXPECT16>:
   30254:	00 00 0f 81 	*unknown*

00030258 <T_IMM_EXPECT17>:
   30258:	00 00 3f 01 	*unknown*

0003025c <T_IMM_EXPECT18>:
   3025c:	00 00 fe 01 	*unknown*

00030260 <T_IMM_EXPECT19>:
   30260:	00 03 fc 01 	*unknown*

00030264 <T_IMM_EXPECT20>:
   30264:	00 0f f8 01 	*unknown*

00030268 <T_IMM_EXPECT21>:
   30268:	00 3f f0 01 	*unknown*
